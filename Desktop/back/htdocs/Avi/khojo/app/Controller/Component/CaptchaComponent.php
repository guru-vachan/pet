...
class CaptchaComponent extends Component{
	...
	public $settings = array(
		'font' => 'fonts/monofont.ttf', //arial.ttf - place font file somewhere and specify path here.
		'width' => 120,
		'height' => 40,
		'characters' => 6,
		'theme'=>'default',
	...
	function generateCode($characters) {
		/* list all possible characters ; similar looking characters and vowels have been removed */
		 $possible =  implode('',array_merge(range('0', '9'),array_merge(range('a', 'z'),range('A', 'Z'))));
		//$possible = '0123456789';
		$code = '';
		$i = 0;
		while ($i < $characters) { 
