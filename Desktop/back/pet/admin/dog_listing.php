...
$cat_sql = mysql_query("SELECT `dog`.*,`categories`.* FROM `dog` LEFT JOIN `categories` ON `dog`.`category_id` = `categories`.`id` LIMIT ".$start.",".$per_page);
$numrows = mysql_num_rows($cat_sql);
//echo $numrows; die;

$sql = mysql_query("SELECT * FROM `dog`");
...
<div class="box-content">
                    <table class="table table-bordered">
						...
						<tr>
                            ...
                            <td class="center">
                                <a href="view_dog.php?p_id=<?php echo $row['p_id'];?>"class="btn btn-success" href="#">
                                ...
                                <a href="dog_delete.php?p_id=<?php echo $row['p_id'];?>" class="btn btn-danger" href="#">
