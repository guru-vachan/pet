...
{ 
  ...
  $sql=mysql_query("INSERT INTO `product`(`p_name`,`p_price`,`product_image`,`category_id`,`short`,`full`) VALUES('".$p_name."',".$p_price.",'".$product_image."','".$p_cat."','".$short."','".$full."')");
   if($sql)
   {
		...
		<div class="alert alert-success">
            ...
            <div class="box-content">
				...
				<div class="form-group">
                        ...
                        <textarea type="text" rows="2" cols="10" class="form-control" name="full" id="full" ></textarea>
