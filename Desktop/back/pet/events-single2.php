        ...
        <div class="container" style="background-color:mediumseagreen">
            <div class="row" style="background-color: darkslategray;">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading" style="margin-top: 20px; margin-bottom: 15px; font-size: 40px;">Costume Show</h2>
			...
			<div style="color:rgb(199, 172, 172)">
				...
				<div class="row" style="padding-top:20px; color:black;">
					<div class="col-lg-offset-1 col-lg-5">
						...
						<img src="img/about/13.jpeg"  class="col-lg-5" style="border-radius: 80%; border-width: 10px; border-style: dotted; border-top-color: rgb(255, 255, 255); border-left-color: rgb(11, 11, 11); border-right-color: rgb(8, 8, 8); border-bottom-color: rgb(251, 250, 253); "/>
				</div>
			</div>
        </div>
    </section>
