...
<?php include('header.php'); ?>
  ...
  <button type="submit" class="btn btn-default">Submit</button>
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
<?php 
	if(isset($_SESSION['matri']['groom']) && !empty($_SESSION['matri']['groom'])) {
		echo "<div class='alert alert-info'>".
                            "<button type='button' class='close' data-dismiss='alert'>&times;</button>".$_SESSION['matri']['groom']."</div>";
		unset($_SESSION['matri']['groom']);
} ?>
				<?php 
                    ...
                    <div class="col-lg-4" style="padding:20px">
						<div>
							...
							<div class="row">
								...
								<a href="buy-groom.php?id=<?php echo $mid; ?>" class="col-lg-2 btn btn-danger"><i class="fa fa-heart"></i> </a>
							</div>
						</div>
					</div>
				<?php } ?>
